...
ScrollReveal().reveal('.katalog2', {  distance: '100px', origin: 'left',delay: 900, easing: 'ease-in'});
ScrollReveal().reveal('.about__text2', {  distance: '100px', origin: 'right', delay: 900, easing: 'ease-in'});
